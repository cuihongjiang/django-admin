...
# from manageSys.settings import SECRET_KEY
# from ninja import Field, ModelSchema, Query, Router, Schema
# from ninja.pagination import paginate
# from JsAdmin.models import Menu, MenuButton, Users
# from utils.js_crud import create, delete, retrieve, update
# from utils.js_jwt import JsJwt
...
#     return JsJSONRenderer(data=menu_tree)
#
#
...
#     token = token.split(" ")[1]
#     token_user = JsJwt(SECRET_KEY).decode(SECRET_KEY, token).payload
